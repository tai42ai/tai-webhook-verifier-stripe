...
[![CI](https://github.com/tai42ai/tai-webhook-verifier-stripe/actions/workflows/ci.yml/badge.svg)](https://github.com/tai42ai/tai-webhook-verifier-stripe/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/tai42ai/tai-webhook-verifier-stripe   # next to your app checkout
cd /path/to/your/app
uv add --editable ../tai-webhook-verifier-stripe
```
